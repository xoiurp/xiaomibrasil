...
export const metadata: Metadata = {
  title: "Mi Brasil - Loja Oficial Xiaomi",
  description: "Loja oficial de produtos Xiaomi no Brasil. Smartphones, acessórios e casa inteligente.",
};
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      <li>
                        <Link href="/shop/smartphones" className="text-gray-600 hover:text-[#FF6700]">
                          Smartphones
                        </Link>
                      </li>
                      <li>
                        <Link href="/shop/acessorios" className="text-gray-600 hover:text-[#FF6700]">
                          Acessórios
                        </Link>
                      </li>
                      <li>
